    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Buku: <?php echo e($book->title); ?></h5>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>" 
                                    <?php if(old('category_id', $book->category_id) == $category->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['copies'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="copies" name="copies" value="<?php echo e(old('copies', $book->copies)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php if($book->cover_image): ?>
                            <div style="margin-top:10px;">
                                <img src="<?php echo e(asset('storage/' . $book->cover_image)); ?>" alt="Cover <?php echo e($book->title); ?>"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\app_laravel1\resources\views/admin/books/edit.blade.php ENDPATH**/ ?>