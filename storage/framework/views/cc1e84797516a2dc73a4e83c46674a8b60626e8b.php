<?php $__env->startSection('title', 'Tiket Peminjaman'); ?>
...
<div class="ticket-page">
    <div class="ticket-wrap">
        <div class="ticket-actions">
            <a href="<?php echo e(route('loans.history')); ?>" class="ticket-btn back"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'arrow-left','class' => 'icon-inline']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'arrow-left','class' => 'icon-inline']); ?>
...
<?php endif; ?>Kembali</a>
            <button type="button" class="ticket-btn print" onclick="window.print()"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>Tiket Peminjaman Buku</h1>
                <p>Bukti peminjaman resmi, simpan atau cetak tiket ini.</p>
            </div>

            <div class="ticket-body">
                <div>
                    <div class="ticket-code"><?php echo e($loan->ticket_code); ?></div>

                    <div class="ticket-row">
                        <label>Peminjam</label>
                        <span><?php echo e($loan->user->name); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Email</label>
                    ...
                    <div class="ticket-row">
                        ...
                        <span><?php echo e($loan->book->title); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Pengarang</label>
                        <span><?php echo e($loan->book->author); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Tanggal Disetujui</label>
                        <span><?php echo e($loan->approved_at ? $loan->approved_at->format('d M Y H:i') : '-'); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Tanggal Pinjam</label>
                        <span><?php echo e($loan->loan_date ? \Carbon\Carbon::parse($loan->loan_date)->format('d M Y') : '-'); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Jatuh Tempo</label>
                        <span><?php echo e($loan->due_date ? \Carbon\Carbon::parse($loan->due_date)->format('d M Y') : '-'); ?></span>
                    </div>
                    <div class="ticket-row">
                        <label>Status</label>
                        <span><?php echo e(ucfirst($loan->status)); ?></span>
                    </div>
                </div>

                <div class="ticket-qr">
                    <img src="<?php echo e($qrUrl); ?>" alt="QR Tiket <?php echo e($loan->ticket_code); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\app_laravel1\resources\views/loans/ticket.blade.php ENDPATH**/ ?>