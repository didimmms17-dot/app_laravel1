    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu" id="navbarMenu">
                <li class="navbar-item {{ request()->routeIs('welcome') ? 'active' : '' }}">
                    <a href="{{ route('welcome') }}">Beranda</a>
                </li>
                <li class="navbar-item {{ request()->routeIs('books.index') ? 'active' : '' }}">
                    <a href="{{ route('books.index') }}">Koleksi Buku</a>
                </li>
                <li class="navbar-item {{ request()->routeIs('categories.*') ? 'active' : '' }}">
                    <a href="{{ route('categories.index') }}">Kategori</a>
                </li>
                @auth
                    @if(auth()->user()->role === 'user')
                        <li class="navbar-item {{ request()->routeIs('loans.history') ? 'active' : '' }}">
                ...
                @auth
                    @php
                        $userUnreadNotifications = \App\Models\Notification::where('user_id', auth()->id())
                            ...
                            ->count();
                    @endphp
                    <a href="{{ route('notifications.index') }}" class="notification-icon" title="Notifikasi">
                        <x-icon name="bell" />
